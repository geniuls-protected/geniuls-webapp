  ...
  return (
    ...
    <div class="container-fluid" style={{marginTop: '20px'}}>
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            ...
            <ul class="navbar-nav">
                <li class="nav-item nav-comp" style={{paddingLeft: '10px', paddingRight: '20px'}}>
                ...
                <li class="nav-item" style={{paddingLeft: '10px', paddingRight: '20px'}}>
                    <a class="nav-link active" style={{padding: '8px 0px 10px 0px'}} href="https://98arnb8wb3v.typeform.com/to/FQMpjsm8" target='_blank' rel="noreferrer"><button className='register-button'>REGISTER</button></a>
                </li>
            </ul>
        </div>
    </div>
